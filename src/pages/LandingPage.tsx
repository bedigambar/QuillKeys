...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen ">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-4 sm:pt-0">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-transparent" />

        <div className="relative z-10 text-center max-w-4xl mx-auto -mt-32 sm:mt-0">
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-mono font-bold mb-6 sm:mb-8 leading-tight px-2">
            Type Through the Minds of
            <span className="block mt-2 sm:mt-4 font-edu font-medium">Those Who Shaped Literature</span>
          </h1>

          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-foreground/80 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
        ...
        <div className="absolute left-2 sm:left-4 md:left-8 top-1/4 opacity-20">
          <img
            src={kafkaPortrait}
            alt="Franz Kafka"
        ...
        <div className="absolute left-2 sm:left-4 md:left-8 bottom-1/4 opacity-20">
          <img
            src={camusPortrait}
            alt="Albert Camus"
        ...
        <div className="absolute right-2 sm:right-4 md:right-8 top-1/4 opacity-20">
          <img
        ...
        <div className="absolute right-2 sm:right-4 md:right-8 bottom-1/4 opacity-20">
          <img
            src={gogolPortrait}
            alt="Nikolai Gogol"
            className="w-16 h-20 sm:w-24 sm:h-32 md:w-32 md:h-40 lg:w-40 lg:h-52 object-cover rounded-lg shadow-deep transform rotate-6"
      ...
      <section className="-mt-20 sm:mt-0 sm:py-8 md:py-12 lg:py-16 xl:py-24 px-4 sm:px-6 pb-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-center mb-3 sm:mb-6 md:mb-8 lg:mb-12">
              ...
              >
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                  <img
                    src={quote.image}
                    alt={quote.author}
                    className="w-16 h-20 sm:w-20 sm:h-24 object-cover rounded-lg shadow-deep group-hover:scale-105 mx-auto sm:mx-0"
                  />
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-card/20">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-serif mb-6 sm:mb-8 px-4">
            Ready to Type Words That Changed the World?
          </h3>

          <p className="text-base sm:text-lg text-foreground/80 mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
